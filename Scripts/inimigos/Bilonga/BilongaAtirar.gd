...
onready var animacaoBilonga= $Bilonga/AnimationPlayer # Animacao
...
func Iniciar_animacao(name):
	if animacaoBilonga.current_animation == name:
		return
	animacaoBilonga.play(name)
